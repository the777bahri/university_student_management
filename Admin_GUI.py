...
class AdminApp:
    ...
    def image_clicked(self, event):
        text_id = self.canvas.create_text(150, 50, text="Work 🤬!", fill="red", font=('Times New Roman', 20, 'bold', 'bold'))
        self.play_sound('sounds\message.mp3')
    ...
    def setup_ui(self):
        ...
        self.create_buttons()
        self.button_open = Button(self.root, text="Remove Student", command=self.remove_student)
    ...
    def create_buttons(self):
        ...
        clear_button = tk.Button(self.root, text="Clear Database", command= self.clears_button_clicked)
